...
function LoanRepayment(props) {
    ...
    function validateInput(userInput) {
        let valid = true;
        let errorObj = {};
        console.log(userInput.emiCollection);
        console.log(userInput.totalEMI - userInput.paidEMI);
    ...
    const emiAmountNeedToPay =
        (emiPending * details.emiAmount)
    // Handle Amount that enter in loan repayment
                                            ...
                                            <Col md="4">
                                                ...
                                                <FormGroup>
                                                    <Input
                                                        ...
                                                        onChange={(event) =>
                                                            setDetails({ ...details, transDate: event.target.value })
                                                        }
                                                    />
                                                </FormGroup>
                                            </Col>
                                            ...
                                            <Col md={12}>
                                                ...
                                                <FormGroup>
                                                    <Input
                                                        ...
                                                        style={{ backgroundColor: props.color }}
                                                        onChange={(event) =>
                                                            setDetails({ ...details, narration: event.target.value })
                                                        }
                                                    />
                                                </FormGroup>
                                            </Col>
