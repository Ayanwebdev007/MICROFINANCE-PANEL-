...
const ReviewGroupForeclosureRequest = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (location.state?.req && location.state.req.transactionId === transactionId) {
          ...
          const res = await axios.get("/api/loan/foreclosure/pending/group-loan");
        ...
        if (!reqData) {
          setSweetAlert(
            <SweetAlert
              ...
              onConfirm={() => {
                setSweetAlert(null);
                navigate("/loan/group-Loan-Foreclose-PendingRequest");
              }}
...
export default ReviewGroupForeclosureRequest;