...
const PendingGroupLoanForeclosureList = () => {
  ...
  useEffect(() => {
    const fetchPendingRequests = async () => {
      try {
        const response = await axios.get("/api/loan/foreclosure/pending/group-loan");
  ...
  const handleForeCloseReview = (req) => {
    navigate(`/group-loan/foreclosure/review/${req.transactionId}`, {
  ...
  const handleApproveRequest = async (transactionId) => {
    try {
      ...
      // Refresh list
      const refresh = await axios.get("/api/loan/foreclosure/pending/group-loan");
...
export default PendingGroupLoanForeclosureList;