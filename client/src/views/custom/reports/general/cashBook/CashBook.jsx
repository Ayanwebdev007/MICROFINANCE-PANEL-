        ...
        <Card>
          ...
          <CardBody>
            <table className='table table-striped table-bordered'>
              ...
              <tr>
                ...
                <th className={'text-right'}>Cash Amount</th>
              </tr>
              </thead>
              {dayTransactions.map((transaction)=>{
                if (transaction.cashCreditAmount > 0 && transaction.transactions.length > 0){
                  return <tbody>
          ...
          <CardBody>
            <table className='table table-striped table-bordered'>
              ...
              {dayTransactions.map((transaction)=>{
                if (transaction.cashDebitAmount > 0 && transaction.transactions.length > 0){
                  return <tbody>
                  <tr className={'bg-success'}>
                    <th className={'text-center'}>{transaction.glCode}</th>
                    <th className={'text-center'} colSpan={2}>{transaction.glHead}</th>
